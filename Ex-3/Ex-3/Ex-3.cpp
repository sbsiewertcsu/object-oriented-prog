// Ex-3.cpp : Defines the entry point for the console application.
//
// This solution for the Exercise #3 in A215, Object Oriented Programming for Engineers
// provides both the REQUIRED features as well as the extra credit analysis and statistics.
...
int main(void)
{
	...
	do
	{
		cout << "Built-in Random number generator with range 0..." << RAND_MAX << " will be used in scaled range 0...49\n";
	...
	for(idx=0; idx < BINS; idx++)
	{
		...
		// EXTRA CREDIT- compute sum and average for each bin
		sum += randcnt[idx];
		...
		// EXTRA CREDIT - compute difference from mean and square it and average over all bins
	...
	// END of REQUIRED solution, from here this is all for EXTRA CREDIT ONLY

	std = sqrt(var);

	// EXTRA CREDIT - Output of overall distribution standard deviation and Excel plot output for all
	...
	fout.open("C:/temp/randstats.txt");
	fout << "seed" << "," << "var" << "," << "std" << "\n";
